...
(lib._final = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		function init() {
			...
			createjs.Sound.registerSound("/WebDevelopmentCourse/finalgame/sounds/GoodSound.mp3", "Good");
			createjs.Sound.registerSound("/WebDevelopmentCourse/finalgame/sounds/back.mp3", "backmusic");
			createjs.Sound.registerSound("/WebDevelopmentCourse/finalgame/sounds/badGood.mp3", "LessGood");
